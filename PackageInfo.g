...
Persons := [
  rec(
    ...
    Institution := "CIEM (Center of Research and Studies in Mathematics) - CONICET - National University of Córdoba",
  ),
  rec(
    FirstNames := "Agustín",
    LastName := "García Iglesias",
    WWWHome := "https://www.famaf.unc.edu.ar/~aigarcia/",
    Email := "agustingarcia@unc.edu.ar",
    IsAuthor := true,
    IsMaintainer := true,
    PostalAddress := "5000",
    Place := "Cordoba - Argentina",
