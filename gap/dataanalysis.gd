...
DeclareGlobalFunction( "QGNAG_MultiplicitiesToDecomposition" );
DeclareGlobalFunction( "QGNAG_PermutationVarChars" );
DeclareGlobalFunction( "QGNAG_LoadCharactersToLaTeXByIndex" );
DeclareGlobalFunction( "QGNAG_LoadCharactersToLaTeX" );
DeclareGlobalFunction( "QGNAG_ShiftRecordKeys" );
DeclareGlobalFunction( "QGNAG_NegateRecordKeys" );
DeclareGlobalFunction( "QGNAG_ShiftRecordKeysToZero" );
DeclareGlobalFunction( "QGNAG_ShiftRecordKeysDecomp" );
DeclareGlobalFunction( "QGNAG_ShiftDecompositionKeys" );